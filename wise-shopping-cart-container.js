...
class WiseShoppingCartContainer extends PolymerElement {
    static get template() {
        ...
        return html`
                            ...
                            <div class="order-details">
                                ...
                                <paper-card>
                                    ...
                                    <paper-input pattern=".*\\S.*" id="clientName" label="Ім'я" required
                                                 ...
                                                 value="[[cart.clientName]]" on-blur="_validateAndSend"></paper-input>
                                    <paper-input id="clientPhone" pattern="^\\d{9}$" label="Телефон" required
                                                 error-message="Заповніть, будь ласка, це поле"
                                                 value="[[cart.clientPhone]]" on-blur="_validateAndSend">
                                        <span slot="prefix">+380</span>
                                    </paper-input>
                                    <paper-input id="clientComments" label="Коментар" value="[[cart.clientComments]]"
            ...
            <iron-ajax id="shopConfigAjax" handle-as="json" on-last-response-changed="_onShopConfigLastResponse"
                       url="http://localhost:3334/shop/details/public"></iron-ajax>
        `;
    }
